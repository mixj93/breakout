...
module.exports = __webpack_require__(/*! /Users/lixueli/codes/breakout/src/main.js */335);
...
var _index = __webpack_require__(/*! ./global/index */ 130);
...
var _class = function (_Phaser$State) {
  ...
  _createClass(_class, [{
    ...
    value: function generateBricks(bricksGroup) {
      ...
      var bricksGroupWidth = (xOffset * columns - (xOffset - brick.width)) / 2;

      bricksGroup.position.setTo(this.game.world.centerX - bricksGroupWidth, this.game.world.centerY - 250);
    }
  }, {
    key: 'setUpbtn',
    value: function setUpbtn() {
      this.scoreText = this.game.add.button(20, this.game.height - 68, 'github', function () {
